    ...
    function c() {
        if (!e) {
            ...
            for (c = 0; c < i.length; c++) {
                ...
                d.src += "#?secret=" + f, d.setAttribute("data-secret", f);
    ...
    if (a.wp = a.wp || {}, !a.wp.receiveEmbedMessage) if (a.wp.receiveEmbedMessage = function(c) {
        ...
        if (d) if (d.secret || d.message || d.value) if (!/[^a-zA-Z0-9]/.test(d.secret)) {
            ...
            for (e = 0; e < j.length; e++) if (f = j[e], c.source === f.contentWindow) {
                ...
                if ("link" === d.message) if (h = b.createElement("a"), i = b.createElement("a"), 
                h.href = f.getAttribute("src"), i.href = d.value, i.host === h.host) if (b.activeElement === f) a.top.location.href = d.value;
            } else ;
        }
    }, d) a.addEventListener("message", a.wp.receiveEmbedMessage, !1), b.addEventListener("DOMContentLoaded", c, !1), 
